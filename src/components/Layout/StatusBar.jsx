...
export default function StatusBar() {
  ...
  return (
    <footer className="mx-7 mb-4 flex h-10 shrink-0 items-center justify-between rounded-2xl border border-white/70 bg-white/48 px-4 text-xs font-black text-slate-500 shadow-sm backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/48 dark:text-slate-400">
